...
def calculate_workout_song_score(audio_features: TrackAudioFeatures):
    ...
    # Normalize tempo to a 0-1 scale (assuming typical workout tempo range of 100 to 150 BPM)
    normalized_tempo = (audio_features["tempo"] - 100) / (150 - 100)
